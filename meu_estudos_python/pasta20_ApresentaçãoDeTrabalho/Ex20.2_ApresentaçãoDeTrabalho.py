...
def mostrar_lista_alunos(lista_alunos):
...
def mostrar_ordem_de_trabalho(lista_alunos):
    if lista_alunos:
...
mostrar_lista_alunos(lista_alunos)
mostrar_ordem_de_trabalho(lista_alunos)
